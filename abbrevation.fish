source ~/.config/fish/abbrevations/git.fish
source ~/.config/fish/abbrevations/ssh.fish
...
source ~/.config/fish/abbrevations/docker.fish
source ~/.config/fish/abbrevations/alembic.fish
